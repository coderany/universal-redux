  ...
  RoutingContext.prototype.render = function render() {
    ...
    if (components) {
      element = components.reduceRight(function (element, components, index) {
        ...
        if ((typeof components === 'undefined' ? 'undefined' : (0, _typeof3.default)(components)) === 'object') {
          var elements = {};
    ...
    !(element === null || element === false || _react2.default.isValidElement(element)) ? process.env.NODE_ENV !== 'production' ? (0, _invariant2.default)(false, 'The root route must render a single element') : (0, _invariant2.default)(false) : undefined;
